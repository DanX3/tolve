...
\begin{itemize}
	...
	\item Marshal
	\lstinputlisting[firstline=16 lastline=21]{logcat}\\
	\lstinputlisting[firstline=23 lastline=28]{logcat}\\
	\lstinputlisting[firstline=30 lastline=35]{logcat}\\
	...
	\lstinputlisting[firstline=37 lastline=41]{logcat}\\
\end{itemize}
\end{document}
